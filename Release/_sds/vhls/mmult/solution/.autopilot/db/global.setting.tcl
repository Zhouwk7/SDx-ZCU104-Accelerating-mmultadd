...
set SourceFiles {sc {} c D:/xilinx/SDSoC_IDE/workspace/muladd/src/mmult.cpp}
set SourceFlags {sc {} c {{-ID:/xilinx/SDSoC_IDE/workspace/muladd/src -Wall -O3 -fmessage-length=0 -D__SDSCC__ -m64 -DHLS_NO_XIL_FPO_LIB -ID:/xilinx/SDSoC_IDE/SDx/2018.3/target/aarch64-linux/include -ID:/xilinx/SDSoC_IDE/workspace/muladd/src -D__SDSVHLS__ -D__SDSVHLS_SYNTHESIS__ -ID:/xilinx/SDSoC_IDE/workspace/muladd/Release -w}}}
set DirectiveFile D:/xilinx/SDSoC_IDE/workspace/muladd/Release/_sds/vhls/mmult/solution/solution.directive
